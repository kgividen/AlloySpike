...
module.exports = function(options) {
    ...
    var radius = (opts.size + opts.margin) / 2 * (Titanium.Platform.displayCaps.logicalDensityFactor || 1);
    console.log('Radius: ' + radius);
    var width = opts.size + opts.margin;
    ...
    self.setProgress = self.setValue;
    return self;
};